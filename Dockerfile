...
#     build-essential software-properties-common cmake git wget curl vim ca-certificates cifs-utils nfs-common pciutils \
...
#     cd .. && \
#     rm -rf MLNX_OFED_LINUX-5.0-1.0.0.0-ubuntu16.04-x86_64 && \
#     rm -rf *.tgz
...
RUN python3 -m pip install --no-cache-dir future typing numpy lxml opencv-python scikit-learn tensorflow-gpu==1.14.0 keras h5py 
